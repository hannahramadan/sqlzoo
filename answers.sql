...
SELECT orders.id, orders.status, orders.order_total FROM orders INNER JOIN customers ON orders.customer_id=customers.id WHERE customers.email = 'pclark74@gmail.com'; 
